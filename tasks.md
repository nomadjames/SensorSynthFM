...
Sep 20 2026 Session 8 (Boddicker + James, physical iPad review): Hold sustain, same-pitch deduplication, fluid retargeting, occupied-pitch merge, selective removal, and Hold-off active-touch ownership passed on the Nomadpad. James found the active halo too small except during motion, the note/Hz label on the playing-arm side, and the release indicator too brief. The first follow-up moved the label correctly and lengthened the matched audio/visual release envelope to 350 ms, but its 52-point centered halo still disappeared beneath a stationary fingertip and the released ring turned white too soon. The next candidate uses an 88-point outer reticle and keeps the dashed release ring orange while it fades. Next: pull, rebuild, and recheck those two feedback details before Freehand and sustained-play review.
